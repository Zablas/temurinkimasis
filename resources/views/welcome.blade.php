...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Temų rinkimosi sistema</title>
    ...
    <body class="antialiased" style="background-color: #d9d9d9">
        <div>
            @if (Route::has('login'))
        ...
        <div class="centered-container">
            <div class="displace-30">
                <h1>Temų rinkimosi sistema</h1>
            </div>
            <div class="center">
                <h2>Parengė: Karolis Balčiūnas, IFF-8/1</h2>
            </div>
        </div>
    </body>
</html>
